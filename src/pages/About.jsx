  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="p-12 bg-white text-center">
        <h2 className="text-3xl font-semibold text-orange-600 mb-6">CIAC Director</h2>
      ...
      <section className="p-12 bg-orange-100 text-center">
        <h2 className="text-3xl font-semibold text-orange-600 mb-6">Advisor Panel</h2>
      ...
      <section className="p-12 bg-white text-center">
        <h2 className="text-3xl font-semibold text-orange-600 mb-6">Core Committee Panel</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      {/* Secretary Panel */}
      <section className="p-12 bg-orange-100 text-center">
        <h2 className="text-3xl font-semibold text-orange-600 mb-6">Secretary Panel</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      {/* Executive Panel */}
      <section className="p-12 bg-white text-center">
        <h2 className="text-3xl font-semibold text-orange-600 mb-6">Executive Panel</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      {/* Notable Alumni */}
      <section className="p-12 bg-orange-100 text-center">
        <h2 className="text-3xl font-semibold text-orange-600 mb-6">SIAS Notable Alumni</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      {/* Featured Events */}
      <section className="p-12 bg-white text-center">
        <h2 className="text-3xl font-semibold text-orange-600 mb-6">Featured Events</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
